...
def run_test_zero_changer():
    ...
    # Test 2:
    test2 = ([0, 0, 0, 4], [5, 6, 0, 1, 4, 0], [2, 3, 0], [4, 0, 4])
    expected2 = ([1, 2, 3, 4], [5, 6, 4, 1, 4, 5], [2, 3, 6], [4, 7, 4])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([0, 0, 0, 0],[1,2,0],[3,2,0] )
    expected3 = ([1, 2, 3, 4], [1, 2, 5], [3, 2, 6])
    zero_changer(test3)
    print()
    print('Test 3:')
